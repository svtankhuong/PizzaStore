...
public class MainGUI extends javax.swing.JFrame {
    ...
    private final Color clMenuItem = new Color(255, 204, 153);
    private final Color clMenuItemSelected = new Color(255, 153, 102);
